...
/* [BOARD-LAYOUT] [SPIRIT] Returns "X" — the single-character abbreviation used for corpse tokens on the board. */
function getCorpseTokenAbbreviation() {
  return "X";
}

/* [BOARD-LAYOUT] Main board canvas component: renders the grid of tiles, player tokens, valid-move overlays, event targets, debug placements, and dog-move options. */
