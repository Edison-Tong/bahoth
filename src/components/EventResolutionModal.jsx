...
/* [EVENT] [CARD-DISPLAY] Renders the textual content inside an Event card (To Do, Result lines). */
...
/* [CARD-DISPLAY] Renders the ability text block for a drawn item/omen/event card (passive, active, special, or event steps). */
...
/* [CARD-DISPLAY] [ONLINE-SYNC] Compact expandable card banner shown to non-active players while another player draws a card. */
...
/* [CARD-DISPLAY] Full drawn-card modal for the active player (or compact CardPeek for spectators). */
...
/* [EVENT-TILE-CHOICE] [BOARD-LAYOUT] Renders the board overlay buttons for event tile-choice targets on the current floor. */
...
/* [EVENT] [OVERLAY] Main event resolution modal: shows roll button/results, awaiting choices, and Rabbit's Foot die picker. */
