...
/* [ITEM-MOVEMENT] [ITEM-ABILITY] Activates the Mask: marks it used, then opens a tile-choice event state to push all co-located explorers to an adjacent tile one at a time. */
...
/* [ITEM-MOVEMENT] [TILE-PLACEMENT] Previews moving a specific player to the chosen tile (highlights destination before confirming). */
...
/* [ITEM-MOVEMENT] [TILE-PLACEMENT] Confirms moving the current target player to the selected tile, then advances to the next target (or clears event state when all targets have been pushed). */
